...
plt.tight_layout()
plt.savefig(images_dir / "daily_price_trend.png")
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig(images_dir / "price_rolling_avg.png")
plt.close()
...
plt.tight_layout()
plt.savefig(images_dir / "price_change_dist.png")
plt.close()

print(f"All images generated successfully in {images_dir}!")
